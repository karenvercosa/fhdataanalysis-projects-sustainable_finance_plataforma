...
export interface Session {
  ...
  company?: string; // empresa relacionada (logo aparece se Ouro/Prata)
  liveUrl?: string; // link da transmissão ao vivo (opcional)
}

export const SESSIONS: Session[] = [
  { id: "s1", title: "Abertura: O futuro das finanças sustentáveis", track: "ESG", room: "Palco Principal", start: "09:00", end: "09:45", speaker: "Helena Vasquez", favorite: true, capacity: 300, company: "FundCo",
  ...
  { id: "s2", title: "Crédito de carbono na prática", track: "Investimentos", room: "Sala B", start: "10:00", end: "10:45", speaker: "Rafael Lima", favorite: true, capacity: 80, company: "CarbonX",
  ...
  { id: "s3", title: "Fintechs verdes e o novo investidor", track: "Inovação", room: "Sala C", start: "10:00", end: "10:45", speaker: "Marina Costa", favorite: false, capacity: 60, company: "Fintech Verde",
  ...
  { id: "s4", title: "Painel: Regulação e taxonomia ESG", track: "ESG", room: "Palco Principal", start: "11:00", end: "12:00", speaker: "Diversos", favorite: true, capacity: 300, company: "FundCo",
  ...
  { id: "s5", title: "Workshop: Mensuração de impacto", track: "Inovação", room: "Sala A", start: "11:00", end: "12:00", speaker: "Lucas Prado", favorite: false, capacity: 50, company: "USP",
  ...
  { id: "s6", title: "Tendências de investimento ESG 2026", track: "Investimentos", room: "Sala B", start: "14:00", end: "14:45", speaker: "Patrícia Gomes", favorite: false, capacity: 80, company: "BankCo",
  ...
  { id: "s7", title: "Green bonds: oportunidades no Brasil", track: "Investimentos", room: "Palco Principal", start: "15:00", end: "15:45", speaker: "André Sato", favorite: false, capacity: 300, company: "AgroVerde",
